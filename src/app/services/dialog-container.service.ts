...
export class DialogContainerService {
  ...
  OpenComponentWithinContainerDialog<C extends Type<IDialogContainer>, R extends Type<ContainedDialogBase>>
  (containerDialogType: C, componentResideType: R, matDialogConfig?: MatDialogConfig): MatDialogRef<R> {
